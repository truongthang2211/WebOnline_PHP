                                                ...
                                                <div class="col-lg-9 col-sm-8 col-xs-12">
                                                    <div class="form-group">
                                                        <select class="form-select" id="StateSelect" name="StateSelect" >
                                                            ...
                                                            <option value="4360">An Giang</option><option value="4361">Kon Tum</option><option value="4362">Đắk Nông</option><option value="4363">Sóc Trăng</option><option value="4364">Bình Phước</option><option value="4365">Hưng Yên</option><option value="4366">Thanh Hóa</option><option value="4367">Quảng Trị</option><option value="4368">Tuyên Quang</option><option value="4369">Quảng Ngãi</option>
                                                            <option value="4370">Hà Nội</option><option value="4371">Lào Cai</option><option value="4372">Vĩnh Long</option><option value="4373">Lâm Đồng</option><option value="4374">Bình Định</option><option value="4375">Nghệ An</option><option value="4376">Kiên Giang</option><option value="4377">Hà Giang</option><option value="4378">Phú Yên</option><option value="4379">Lạng Sơn</option>
                                                            <option value="4380">Đà Nẵng</option><option value="4381">Sơn La</option><option value="4382">Tây Ninh</option><option value="4383">Nam Định</option><option value="4384">Lai Châu</option><option value="4385">Bến Tre</option><option value="4386">Khánh Hòa</option><option value="4387">Bình Thuận</option><option value="4388">Cao Bằng</option><option value="4389">Hải Phòng</option>
                                                            <option value="4390">Ninh Bình</option><option value="4391">Yên Bái</option><option value="4392">Gia Lai</option><option value="4393">Hoà Bình</option><option value="4394">Bà Rịa - Vũng Tàu</option><option value="4395">Cà Mau</option><option value="4396">Bình Dương</option><option value="4397">Cần Thơ</option><option value="4398">Thừa Thiên Huế</option><option value="4399">Đồng Nai</option>
                                                            <option value="4400">Tiền Giang</option><option value="4401">Điện Biên</option><option value="4402">Vĩnh Phúc</option><option value="4403">Quảng Nam</option><option value="4404">Đắk Lắk</option><option value="4405">Thái Nguyên</option><option value="4406">Hải Dương</option><option value="4407">Bạc Liêu</option><option value="4408">Trà Vinh</option><option value="4409">Thái Bình</option>
                                                            <option value="4410">Hà Tĩnh</option><option value="4411">Ninh Thuận</option><option value="4412">Đồng Tháp</option><option value="4413">Long An</option><option value="4414">Hậu Giang</option><option value="4415">Quảng Ninh</option><option value="4416">Phú Thọ</option><option value="4417">Quảng Bình</option><option value="4418">Hồ Chí Minh</option><option value="4419">Hà Nam</option>
                                                            <option value="4420">Bắc Ninh</option><option value="4421">Bắc Giang</option><option value="4422">Bắc Kạn</option></select>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
